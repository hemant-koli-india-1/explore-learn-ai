...
-- Create departments table (recreate it)
...
-- Insert a default department for existing courses
INSERT INTO public.departments (name, description, image_url) 
VALUES ('Default Department', 'Default department for migrated courses', 'https://via.placeholder.com/300');

-- Update existing courses to reference the default department
UPDATE public.courses SET department_id = 1 WHERE department_id IS NOT NULL;
